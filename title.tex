...
\newcommand{\MainTitle}{Accent base model for speech spoofing countermeasures in a bilingual system.}
...
\titlehead{%
    \begin{minipage}{0.5\textwidth}
        \centering
        \begin{flushleft}
            \includegraphics[height=3cm]{figures/uniandes-logo}
        \end{flushleft}
    \end{minipage}
    \begin{minipage}{0.5\textwidth}
        \centering
        \begin{flushright}
            \includegraphics[height=1.5cm]{figures/Flag-logo}
        \end{flushright}
    \end{minipage}
}
...
\publishers{%
    ...
    for a degree of Master in Systems and Computing Engineering (MISIS).
}}
\vfill
\begin{tabularx}{1.01\linewidth}{Xr}
    \textbf{Thesis Committee:} & \\[1ex]
    Prof. Ruben Francisco \textsc{Manrique} (Advisor) & 
